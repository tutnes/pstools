...
Param(
  ...
  [string]$message,
  [Parameter(Mandatory=$True)][string]$entrytype # Information, Warning, Error
)
...
$temp_hist_file = $computername + "_" + $log + "_" + $source + "_" + $eventid +  "_" + $message +  "_" + $entrytype + "_loghist.xml" 
